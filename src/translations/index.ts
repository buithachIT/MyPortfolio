...
`,
    ...
    skills: {
      ...
      subtitle: "Những công nghệ mình làm việc",
      frontend: "Frontend",
      backend: "Backend",
      tools: "Công cụ",
      languages: "Ngôn ngữ",
    ...
    projects: {
      ...
      subtitle: "Những dự án mình đã làm",
    ...
    contact: {
      ...
      subtitle: "Hãy liên hệ nếu bạn muốn làm việc cùng mình",
      name: "Tên của bạn",
      email: "Email của bạn",
  ...
  en: {
    ...
    hero: {
      greeting: "Hi, I am",
      role: "Website Developer – UI/UX Lover",
      from: "-come from-: SGU",
      skills: "My Skills",
    ...
    about: {
      ...
      titleEnd: "",
      description: `<strong>I’m </strong>a Website Developer passionate about building modern, user-friendly web interfaces.<br/>
...
<strong>Feel free</strong> to contact me via email or through the social networks below!`,
    ...
    contact: {
      title: "Contact Me",
      subtitle: "Get in touch if you want to work together",
      name: "Your Name",
      email: "Your Email",
